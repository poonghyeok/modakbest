		          ...
		          <form action="/bitcampfire/user/userSignupComplete" method="post" class="form-signup form-user panel-body" id="userSignupWriteForm">
		              ...
		              <fieldset>
		                ...
		                <div class="signup-block">
		                   <!--  <a href="#" type="button" data-toggle="modal"  data-bs-target="#agreeModal">회원가입약관</a> <span class="inline-saperator">/</span> <a href="#" type="button" data-toggle="modal" data-bs-target="#privacyModal">개인정보취급방침</a> -->
		                	<button type="button" data-bs-toggle="modal" data-bs-target="#agreeModal" id="signupAgreeBtn">회원가입약관</button><span class="inline-saperator">/</span><button type="button" id="signPersonBtn" data-bs-toggle="modal" data-bs-target="#privacyModal">개인정보취급방침</button>
		                </div>

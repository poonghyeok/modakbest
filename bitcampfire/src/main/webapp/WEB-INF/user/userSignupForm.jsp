...
<form id="userSignupWriteForm" method="post" action="/bitcampfire/user/userSignupComplete"><!-- method="post" action="/bitcampfire/user/SignupComplete" -->
	<table>
      		...
      		<div class="input-form col-md-10 mx-auto">
				...
				<div id="email_div">
		        	...
		        	<div class="row" id="num_check_blank">
		            	<div class="col-md-8">
		              		<label for="user_email_check_number"  class="form-label" id="input_num">인증번호입력</label>
							...
							<label for="mail-check-input" class="form-label" id="mail-check-input_font">인증</label>
					  		<button type="button" id="mail-check-input" class="btn btn-primary btn-sm">인증번호 인증</button>
		            	</div>
	          	...
	          	<div class="row">
	            	<div class="col-md-6 mb-3">
				  		...
				  		<input type="password" class="form-control" name ="user_pwd" id="user_pwd" placeholder="비밀번호" maxlength="15">
	            	</div>
	           		 <div class="col-md-6 mb-3">
	             		 <label for="user_repwd" class="form-label" id="repwd_check">비밀번호 확인</label>
				  		<input type="password" class="form-control" name ="user_repwd" id="user_repwd" placeholder="비밀번호를 확인">
	            	</div>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
					  <label for="class_academy" class="form-label">학원명</label>
					  <input type="text" class="form-control" name ="class_academy" id="class_academy" placeholder="학원명">
					</div>
					
					<div class="col-md-6 mb-3">
					  <label for="class_class" class="form-label">과정명</label>
					  <input type="text" class="form-control" name ="class_class" id="class_class" placeholder="과정명">
					</div>
				</div>
				
				<div class="col-md-6 mb-3">
					<label for="user_img" class="form-label">프로필사진</label>
				...
				<div class="col-md-6 mb-3">
					...
					<div id="flexCheckCheckedDiv"></div>
				</div>
				
				<div class="d-grid gap-2 col-12 mx-auto">
					<button class="btn btn-primary" type="button" id="signUpBtn">아래 약관을 동의하며 계정 생성</button>
					 <div class="signup-block">
					  	<button type="button" data-bs-toggle="modal" data-bs-target="#agreeModal">회원가입약관</button>
					  	<button type="button" data-bs-toggle="modal" data-bs-target="#privacyModal">개인정보취급방침</button>
	                </div>
				</div>
